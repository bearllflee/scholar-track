...
type FileInfoResponse struct {
	...
	FileId      uint64 `protobuf:"varint,1,opt,name=file_id,json=fileId,proto3" json:"file_id,omitempty"`                // 文件ID
	FileUrl     string `protobuf:"bytes,2,opt,name=file_url,json=fileUrl,proto3" json:"file_url,omitempty"`              // 文件URL
	FileName    string `protobuf:"bytes,3,opt,name=file_name,json=fileName,proto3" json:"file_name,omitempty"`           // 文件名
	FileType    string `protobuf:"bytes,4,opt,name=file_type,json=fileType,proto3" json:"file_type,omitempty"`           // 文件MIME类型
	FileSize    uint64 `protobuf:"varint,5,opt,name=file_size,json=fileSize,proto3" json:"file_size,omitempty"`          // 文件大小
	BussinessId uint64 `protobuf:"varint,6,opt,name=bussiness_id,json=bussinessId,proto3" json:"bussiness_id,omitempty"` // 业务ID
	...
	DeletedAt   int64  `protobuf:"varint,9,opt,name=deleted_at,json=deletedAt,proto3" json:"deleted_at,omitempty"`       // 删除时间
}
...
var file_storage_proto_rawDesc = []byte{
	...
	0x07, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x22, 0x8d, 0x01, 0x0a, 0x11, 0x46, 0x69, 0x6c,
	...
	0x73, 0x69, 0x6e, 0x65, 0x73, 0x73, 0x49, 0x64, 0x22, 0x48, 0x0a, 0x12, 0x46, 0x69, 0x6c, 0x65,
	...
	0x52, 0x07, 0x66, 0x69, 0x6c, 0x65, 0x55, 0x72, 0x6c, 0x12, 0x17, 0x0a, 0x07, 0x66, 0x69, 0x6c,
	0x65, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x66, 0x69, 0x6c, 0x65,
	0x49, 0x64, 0x22, 0x2e, 0x0a, 0x13, 0x46, 0x69, 0x6c, 0x65, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f,
	...
	0x49, 0x64, 0x22, 0x33, 0x0a, 0x14, 0x46, 0x69, 0x6c, 0x65, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f,
	...
	0x69, 0x6c, 0x65, 0x44, 0x61, 0x74, 0x61, 0x22, 0x2c, 0x0a, 0x11, 0x46, 0x69, 0x6c, 0x65, 0x44,
	...
	0x69, 0x6c, 0x65, 0x49, 0x64, 0x22, 0x14, 0x0a, 0x12, 0x46, 0x69, 0x6c, 0x65, 0x44, 0x65, 0x6c,
	0x65, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x2a, 0x0a, 0x0f, 0x46,
	...
	0x06, 0x66, 0x69, 0x6c, 0x65, 0x49, 0x64, 0x22, 0x9d, 0x02, 0x0a, 0x10, 0x46, 0x69, 0x6c, 0x65,
	...
	0x69, 0x6c, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x62, 0x75, 0x73, 0x73, 0x69,
	0x6e, 0x65, 0x73, 0x73, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x62,
	0x75, 0x73, 0x73, 0x69, 0x6e, 0x65, 0x73, 0x73, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x72,
	...
	,
...
var file_storage_proto_depIdxs = []int32{
	0, // 0: storage.Storage.FileUpload:input_type -> storage.FileUploadRequest
	2, // 1: storage.Storage.FileDownload:input_type -> storage.FileDownloadRequest
	4, // 2: storage.Storage.FileDelete:input_type -> storage.FileDeleteRequest
	6, // 3: storage.Storage.FileInfo:input_type -> storage.FileInfoRequest
	1, // 4: storage.Storage.FileUpload:output_type -> storage.FileUploadResponse
	3, // 5: storage.Storage.FileDownload:output_type -> storage.FileDownloadResponse
	5, // 6: storage.Storage.FileDelete:output_type -> storage.FileDeleteResponse
	7, // 7: storage.Storage.FileInfo:output_type -> storage.FileInfoResponse
