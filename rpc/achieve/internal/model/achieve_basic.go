...
type AchieveBasic struct {
	global.StModel
	Code        string    `json:"code" form:"code" gorm:"column:code;comment:成果编号;uniqueIndex"`
	...
	TeamMembers []uint64  `json:"teamMembers" form:"teamMembers" gorm:"column:team_members;comment:团队成员ID"`
	// OtherInfo   []PropertyValue `json:"otherInfo" form:"otherInfo" gorm:"foreignKey:BasicId;"`
	OtherInfo map[string]interface{} `json:"otherInfo" form:"otherInfo" gorm:"column:other_info;comment:其他信息;type:json"`
}
